...
from ...schemas import ApiEnvelope, FlexibleSchema, KnowledgeSourceSyncRequest, KnowledgeSourceUpsertRequest
from ..dependencies import CurrentUoW, CurrentUser

router = APIRouter(tags=["knowledge_ingestion"])


@router.get("/api/v1/knowledge/sources", response_model=ApiEnvelope[FlexibleSchema])
...
@router.post("/api/v1/knowledge/sources", response_model=ApiEnvelope[FlexibleSchema])
...
@router.post("/api/v1/knowledge/sources/{source_connection_id}/sync", response_model=ApiEnvelope[FlexibleSchema])
...
@router.get("/api/v1/knowledge/sources/{source_connection_id}/runs", response_model=ApiEnvelope[FlexibleSchema])
