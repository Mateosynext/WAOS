...
@router.post("/api/v1/vertical-transactions/accounts")
...
@router.get("/api/v1/vertical-transactions/accounts/{account_id}")
...
@router.post("/api/v1/vertical-transactions/accounts/{account_id}/commands")
...
@router.post("/api/v1/vertical-transactions/accounts/{account_id}/execute-playbook")
