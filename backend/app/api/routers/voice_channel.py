...
@router.post('/api/v1/voice-channel/sessions/start')
...
@router.get('/api/v1/voice-channel/sessions')
...
@router.get('/api/v1/voice-channel/sessions/{session_id}')
...
@router.post('/api/v1/voice-channel/sessions/{session_id}/turns')
...
@router.post('/api/v1/voice-channel/sessions/{session_id}/interrupt')
...
@router.post('/api/v1/voice-channel/sessions/{session_id}/handoff')
