...
from ...schemas import MarketplaceInstallRequest, MarketplacePackagePublishRequest, MarketplaceUpgradeRequest
from ..dependencies import CurrentUoW, CurrentUser

router = APIRouter(tags=["vertical_marketplace"])


@router.post("/api/v1/vertical-marketplace/packages")
...
@router.get("/api/v1/vertical-marketplace/packages")
...
@router.get("/api/v1/vertical-marketplace/packages/{package_id}")
...
@router.post("/api/v1/vertical-marketplace/install")
...
@router.get("/api/v1/vertical-marketplace/installs")
...
@router.post("/api/v1/vertical-marketplace/installs/{install_id}/upgrade")
