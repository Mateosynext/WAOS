...
def ensure_vertical_transaction_schema(conn: Any) -> None:
    assert_schema_ready(
        conn,
        owner="vertical_transactions",
        tables=(
            "vertical_transaction_accounts",
            "vertical_transaction_commands",
            "vertical_transaction_events",
            "vertical_transaction_ledger",
            "vertical_transaction_documents",
            "vertical_transaction_resources",
            "vertical_transaction_views",
        ),
    )
