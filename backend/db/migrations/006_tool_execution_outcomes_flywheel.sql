ALTER TABLE outcome_exposures ADD COLUMN tool_execution_run_id TEXT;
ALTER TABLE outcome_exposures ADD COLUMN tool_action TEXT;
ALTER TABLE outcome_exposures ADD COLUMN tool_adapter_key TEXT;
ALTER TABLE outcome_exposures ADD COLUMN tool_provider TEXT;

ALTER TABLE outcome_events ADD COLUMN source_execution_run_id TEXT;
ALTER TABLE outcome_events ADD COLUMN source_tool_action TEXT;
ALTER TABLE outcome_events ADD COLUMN source_tool_provider TEXT;
