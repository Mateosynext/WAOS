...
export default async function RevenueRedirectPage({ searchParams }: { searchParams?: Promise<SearchParams> }) { redirect(appendSearchParams("ingresos", (await searchParams) || {})); }
