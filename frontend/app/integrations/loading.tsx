export default function Loading() {
  return (
    <main className="mx-auto grid w-full max-w-7xl gap-6 px-4 py-8 sm:px-6 lg:px-8" aria-busy="true" aria-label="Cargando integraciones">
      <section className="rounded-[32px] border border-[color:var(--border-soft)] bg-[color:var(--surface-elevated)] p-6 shadow-[var(--shadow-sm)]">
        ...
        <p className="mt-4 max-w-2xl text-sm leading-6 text-[color:var(--text-secondary)]">Preparando estado, configuración u observabilidad según la sección activa.</p>
      </section>
