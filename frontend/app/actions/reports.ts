...
import { postJson, runAndRefresh } from "./shared";
...
export async function generateExecutiveReportAction(formData: FormData) {
  ...
  await runAndRefresh(redirectTo, () => postJson('/api/v1/reports/executive/generate', { organization_id: organizationId, period_start: periodStart, period_end: periodEnd, bot_id: botId, delivery_channels: ["ui"] }));
}
