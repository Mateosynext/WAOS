...
import { ACCESS_COOKIE, API_BASE, BOT_COOKIE, ORG_COOKIE, REFRESH_COOKIE, ActionState, cookies, readString, sessionCookieOptions } from "./shared";
...
export async function loginAction(_: ActionState, formData: FormData): Promise<ActionState> {
  ...
  if (!API_BASE) return { ok: false, error: "Configura API_INTERNAL_URL o API_BASE_URL para iniciar sesión." };
